...
public class Main {
    ...
    public static void testVehicle() {
        ...
        Vehicle v2 = new Vehicle("Honda",new Date(), "Prelude", "Coupe",new VehicleChassis("Unibody"),"null", "type",
                new ManufacturedEngine("Honda", new Date(), "H-series","H23A1", "88 AKI", 4, "2WD: Two-Wheel Drive"));
